    ...
    if not args.tpronly:
        if args.min:
            ...
            pool_process = pool.map_async(gromacs, [(args.gmx+' grompp -po '+setup_files+'/em_out-'+str(i)+
                                    ' -f '+running_dir+'/em.mdp -p '+args.p+' -n '+args.n+' -maxwarn 3 -c '+
...
def make_umbrella_windows(offset_end):
    ...
    if args.min:
        ...
        +' -maxwarn 3 -c '+minimised_frames+'window_'+str(i)+'/window_'+str(i)+'.gro -r '+minimised_frames+'/window_'+str(i)+'/window_'+str(i)+'.gro -o '\
        ...
        pool_process = pool.map_async(gromacs, [(args.gmx+' grompp -po '+setup_files+'/md_out-'+str(i)+' -f '+args.mdp+' -p '+args.p+' -n '+args.n\
        +' -maxwarn 3 -c '+frames+'window_'+str(i)+'.pdb -r '+frames+'/window_'+str(i)+'.pdb  -o '+umbrella_windows+'/window_'\
